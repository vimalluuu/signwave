...
async function main() {
  ...
  // Read the sitemap index, parse the xml, under sitemapindex add a new sitemap to https://signwave.com/docs/sitemap.xml
  ...
  const newSitemap = `${preText}<sitemap><loc>https://signwave.com/docs/sitemap.xml</loc></sitemap>${postText}`;
